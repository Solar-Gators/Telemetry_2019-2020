...
ORION_MESSAGE_0::ORION_MESSAGE_0(uint16_t canAddress):
SUBSYSTEM_DATA_MODULE_TEMPLATE_INTERFACE<ORION_MESSAGE_0, ORION_MESSAGE_0_DATA_PACKET>{canAddress,subsystem_info::BMS0_MSG_LENGTH, false, false, false}
{}
