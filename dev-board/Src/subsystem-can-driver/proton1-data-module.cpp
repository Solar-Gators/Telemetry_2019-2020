...
PROTON1_MESSAGE_0::PROTON1_MESSAGE_0(uint16_t canAddress):
SUBSYSTEM_DATA_MODULE_TEMPLATE_INTERFACE<PROTON1_MESSAGE_0, PROTON1_MESSAGE_0_DATA_PACKET>{canAddress,subsystem_info::MPPT0_MSG_LENGTH, false, false, true},
RF_ID{PROTON1_COUNT++}
{}
