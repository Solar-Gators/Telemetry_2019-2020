...
SUBSYSTEM_DATA_MODULE_TEMPLATE_INTERFACE<MOTOR_DRIVER_TX_RL_MESSAGE, MOTOR_DRIVER_TX_RL_DATA_PACKET>{subsystem_info::MOTORTX_RL_MSG_ID,subsystem_info::MOTORTX_RL_MSG_LENGTH, true}
{}
/*****************RX Classes*****************/
//RX Frame 0
...
SUBSYSTEM_DATA_MODULE_TEMPLATE_INTERFACE<MOTOR_DRIVER_RX_FRAME_0, MOTOR_DRIVER_RX_FRAME_0_DATA_PACKET>{subsystem_info::MOTORRX0_RL_MSG_ID,subsystem_info::MOTORRX0_RL_MSG_LENGTH, true}
{}
...
SUBSYSTEM_DATA_MODULE_TEMPLATE_INTERFACE<MOTOR_DRIVER_RX_FRAME_2, MOTOR_DRIVER_RX_FRAME_2_DATA_PACKET>{subsystem_info::MOTORRX2_RL_MSG_ID,subsystem_info::MOTORRX2_RL_MSG_LENGTH, true}
{}
